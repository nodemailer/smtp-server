...
class SMTPServer extends EventEmitter {
    constructor(options) {
        ...
        // set default value for allowIPLiteralAddresses to false (disable IP literal addresses by default for security)
        if (this.options.allowIPLiteralAddresses === undefined) {
            this.options.allowIPLiteralAddresses = false;
        }
