...
// Usernames with control characters have no legitimate use and enable
// log and header injection in applications that embed the value of the
// onAuth username unescaped, so reject these for all mechanisms
